...
local config = {
    ...
    deck_name = "Custom Deck 1 ( Yomi )",            -- name of the deck for new cards
    model_name = "Yomi", -- Tools -> Manage note types
...
local function join_media_fields(new_data, stored_data)
    for _, field in pairs { config.audio_field, config.miscinfo_field } do
